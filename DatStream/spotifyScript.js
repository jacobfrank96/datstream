...
var access_token = 'BQA9kJVNYVos6JEB1EckcYiYsmkSoG-C8dsyCCIYTSy4ahl8hXJMlCvfoT6p8Fp1I7XwCyFbZARANreUO3T7ItlyNUP2mCq4iyY66L_L0ToPWuDky5EgkjiAK8obqbFU68Fu7OF4pHVmj3nPWQ';
        ...
        if(tracksResults.length<100){
            for (i = 0; i < tracksResults.length; i++) {
                ...
                //$("#results ul").append(`<li><iframe src="https://embed.spotify.com/?them=white&uri=spotify:track:${tracksResults[i]}" height = 400></iframe></li>`);
                 //$("#spotifyResults ul").append(`<li><div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="https://embed.spotify.com/?them=white&uri=spotify:track:${tracksResults[i]}" width="300" height="80" frameborder="0"></iframe></div></li>`);
                 ...
                 //$('#spotifyResults').append($('<p></p>').html("append?"));
                 $("#spotifyResults").append(`<li><div class = "spotify-embeds"><iframe class="embed-responsive-item" src="https://embed.spotify.com/?them=white&uri=spotify:track:${tracksResults[i]}" width="300" height="80" frameborder="0"></iframe></div></li>`);
            }
        }
        else{
             for (i = 0; i < 100; i++) {
